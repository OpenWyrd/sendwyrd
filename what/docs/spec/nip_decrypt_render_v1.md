...
- Decryption agent: from the user's browser at sendwyrd.com to the user's Nostr client.
...
- NIP-C6 (withdrawn) — [nostr-protocol/nips#2327](https://github.com/nostr-protocol/nips/pull/2327) — predecessor; see `nip_capability_url_v1.md` for context
