...
If your team uses Obsidian for visual browsing, add `.obsidian/` with theme and plugin configuration. See the [aDNA repo](https://github.com/LatticeProtocol/adna) for a pre-configured setup with 13 plugins and the Tokyo Night theme.
